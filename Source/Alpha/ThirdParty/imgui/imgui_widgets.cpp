...
// Tip: use ImGuiDetails::PushID()/PopID() to push indices or pointers in the ID stack.
...
// - If you want to use ImGuiDetails::InputText() with std::string, see misc/cpp/imgui_stdlib.h
