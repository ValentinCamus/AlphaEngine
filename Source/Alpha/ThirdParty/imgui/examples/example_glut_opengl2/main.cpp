...
#include "imgui.h"
#include "Alpha/ThirdParty/imgui/examples/imgui_impl_glut.h"
#include "Alpha/ThirdParty/imgui/examples/imgui_impl_opengl2.h"
#ifdef __APPLE__
    #include <GLUT/glut.h>
#else
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Dear ImGuiDetails GLUT+OpenGL2 Example");
