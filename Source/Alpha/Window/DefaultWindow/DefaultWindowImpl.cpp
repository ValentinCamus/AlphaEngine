...
namespace Alpha
{
    ...
    void DefaultWindowImpl::Shutdown()
    {
        --Glfw::nInstance;
    ...
    void DefaultWindowImpl::OnUpdate()
    {
        AppTickEvent event;
    ...
    void DefaultWindowImpl::SetupEventsCallback()
    {
