...
namespace Alpha
{
    ...
    std::vector<Pointer<StaticMesh>> MeshLoader::s_meshes = std::vector<Pointer<StaticMesh>>();
    ...
    Pointer<StaticMesh> MeshLoader::ProcessMesh(aiMesh* mesh, const aiScene* scene)
    {
